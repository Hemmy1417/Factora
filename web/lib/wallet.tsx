 ...
 * Factora — the connected address IS the identity: sellers, buyers and
 * capital providers are all just wallets acting against the contract.
 *
...
const LAST_WALLET = "factora:last-wallet";
